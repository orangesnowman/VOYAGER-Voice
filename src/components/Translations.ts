...
export const translations = {
  EN: {
    ...
    welcomeMsg: "Hi! I'm USA Voyager, your conversation partner. Let's make your practice an amazing adventure! Ready to start?",
  ...
  ES: {
    ...
    welcomeMsg: "¡Hola! Soy USA Voyager, tu compañero de conversación. ¡Hagamos de tu práctica una gran aventura! ¿Listo para comenzar?",
    endConversation: "FINALIZAR",
    reviewChat: "Califica tu Sesión con Voyager",
    submitReview: "Enviar Calificación",
