...
export const Missions: React.FC<MissionsProps> = ({
  ...
  return (
    <div className="w-full h-full flex flex-col bg-[#FAF5EC] text-zinc-900 rounded-2xl p-4 font-sans overflow-hidden max-h-[380px] md:max-h-[440px] tab-content-area">
